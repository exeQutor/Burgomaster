...
class Burgosoft {
  ...
  function wp_enqueue_scripts() {
    ...
    // if (is_front_page()) {
 		...
 		// 	wp_enqueue_script('jquery', get_template_directory_uri() . '/bower_components/jquery/dist/jquery.min.js', [], false, true);
 		// }
    ...
    // Stellar JS
		wp_enqueue_script('stellar', get_template_directory_uri() . '/bower_components/jquery.stellar/jquery.stellar.min.js', ['jquery'], false, true);

    // Slick Carousel
		wp_enqueue_script('slick', get_template_directory_uri() . '/bower_components/slick-carousel/slick/slick.min.js', ['jquery'], false, true);
